...
export default class Sujet2 extends Component{
    render(){
        return(
            <div>
                ...
                <div className="box-forum">
                    <div className="container-forum">
                        <div> 
                            <h4 className="forum">Sujet 11</h4>
                ...
                <div className="box-forum">
                    <div className="container-forum">
                        <div> 
                            <h4 className="forum">Sujet 12</h4>
                ...
                <div className="box-forum">
                    <div className="container-forum">
                        <div> 
                            <h4 className="forum">Sujet 13</h4>
                ...
                <div className="box-forum">
                    <div className="container-forum">
                        <div> 
                            <h4 className="forum">Sujet 14</h4>
                ...
                <div className="box-forum">
                    <div className="container-forum">
                        <div> 
                            <h4 className="forum">Sujet 15</h4>
                ...
                <div className="button-group">
                    <ButtonGroup className="me-2" aria-label="First group">
                        <Button as={Link} to="/sujet1" variant="secondary">Previous</Button>{' '}
